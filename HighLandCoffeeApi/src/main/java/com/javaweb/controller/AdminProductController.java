...
public class AdminProductController {
	...
	public ResponseEntity<Product> updatePoroductHandler(@RequestBody Product rq, @PathVariable String productId,@RequestHeader("Authorization") String jwt) throws ProductException, UserException{
		User user = userService.findUserByJwt(jwt);
		Staff staff = staffService.findStaffByUserId(user.getUser_id());
